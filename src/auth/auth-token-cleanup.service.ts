...
export class AuthTokenCleanupService {
    ...
    async handleCron() {
        this.logger.log('Iniciando a limpeza de tokens (Magic Links) expirados ou usados...');
        ...
        try {
            ...
            this.logger.log(`Limpeza concluída. ${result.count} tokens removidos do banco de dados.`);
        } catch (error) {
